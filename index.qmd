...
# Create univariate chloropleth to visualize number of chemical facilities by county
...
# Create scatterplot
# mhcf_scatter <- [insert dataframe with the chemical facility counts by state and maternal health rates] %>% ggplot(aes(x = [insert chemical facility count column], y = [insert maternal health rate column(s)])) + geom_point(alpha = 0.5) + labs(title = "Number of Chemical Facilities and Maternal Health Outcomes", x = "Number of Chemical Facilities per State", y = "Maternal Health Outcome) + theme_minimal()
# mh = maternal health, cf = chemical facilities
