...
# Create a new column with the summarized preterm births and calculate the total number of preterm births and the preterm birth rate
preterm_county <- preterm_county %>%
  left_join(
...
# Make characters numeric, and then change county name to be consistent with the chemical data
fertility_cesarean_county <- fertility_cesarean_county %>%
  mutate(
